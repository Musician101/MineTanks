...
{
    public CreateSpigotCommand()
    {
        super(CommonCommands.CREATE_NAME, CommonCommands.CREATE_DESC, new SpigotCommandUsage(Arrays.asList(new SpigotCommandArgument(CommonCommands.MT_CMD), new SpigotCommandArgument(CommonCommands.CREATE_NAME), new SpigotCommandArgument(CommonCommands.NAME, Syntax.REPLACE, Syntax.REQUIRED)), 1), new SpigotCommandPermissions(CommonPermissions.EDIT_PERM, true, ChatColor.RED + CommonMessages.NO_PERMISSION, ChatColor.RED + CommonMessages.PLAYER_ONLY));
    }
    ...
    public boolean onCommand(CommandSender sender, String... args)
    {
        ...
        SpigotBattleFieldStorage fieldStorage = SpigotMineTanks.instance().getFieldStorage();
