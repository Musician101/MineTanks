...
public enum Tanks implements IInfo
{
	...
	/** French Mediums */
	BAT_CHAT_25_T(4, "Bat.-Chatillon 25 t", TankTypes.MEDIUM, 1800, 25.28, 60, 40, 30, 65, new Cannons("105 mm mle. 57 (D. 1504)", 30, 5.89), new Engines("Hispano-Suiza HS 110", TankTypes.MEDIUM), new Radios("SCR 528", TankTypes.MEDIUM), Tracks.BAT_CHAT_25_T, Turrets.BAT_CHAT_25_T, new String[]{"High mibility.", "Cannon has a clip for quick damage, but a long base reload."}),
	/** French Heavies */
	...
	/** French Arty */
	BAT_CHAT_155_58(7, "Bat.-Chatillon 155 58", TankTypes.ARTY, 490, 35, 50, 30, 20, 62, new Cannons("180 mm B-1-P", 18, 1.71), new Engines("Hispano-Suiza HS 110", TankTypes.ARTY), new Radios("SCR 528", TankTypes.ARTY), Tracks.OBJECT_268, Turrets.NO_TURRET_ARTY, new String[]{"Very mobile.", "Cannon has a clip for quick damage, but a long base reload."}),
	/** German Lights */
	...
	/** German Arty */
	GW_E_100(16, "G.W. E 100", TankTypes.ARTY, 550, 87, 80, 50, 40, 40, new Cannons("21 cm Morser 18/2", 30, 1.41), new Engines("Maybach HL 234 TRM P45", TankTypes.ARTY), new Radios("10WSc", TankTypes.ARTY), Tracks.GW_E_100, Turrets.NO_TURRET_ARTY, new String[]{"Immune to ramming from most medium tanks.", "Better damage per minute than the T92."}),
	/** Japanese Mediums */
