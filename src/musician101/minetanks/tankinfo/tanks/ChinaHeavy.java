...
{
	IS_2(0, "IS-2", 90, 90, 60, 37, new Engines("12150LS", TankTypes.HEAVY), new Cannons("122 mm D-25T", 28, 4.88), Turrets.IS_2_LATE, Tracks.IS_2_LATE, new Radios("A-220", TankTypes.HEAVY)),
	_110(1, "110", 120, 90, 60, 40, new Engines("12150LS", TankTypes.HEAVY), new Cannons("100 mm 62-100T", 40, 6), Turrets.T_10, Tracks._110_1, new Radios("A-220A", TankTypes.HEAVY)),
	WZ_111(2, "WZ-111 model 1-4", 120, 80, 60, 50, new Engines("12150LT", TankTypes.HEAVY), new Cannons("130 mm 59-130T", 40, 4.29), Turrets.WZ_111, Tracks.WZ_111_MODEL_4, new Radios("A-220A", TankTypes.HEAVY)),
	_113(3, "113", 120, 90, 70, 50, new Engines("V-2-54SC", TankTypes.HEAVY), new Cannons("122 mm 60-122T", 34, 5.5), Turrets._113, Tracks._113, new Radios("A-220B", TankTypes.HEAVY));
