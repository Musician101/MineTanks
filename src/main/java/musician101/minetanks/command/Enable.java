...
public class Enable implements ICommand
{
	@Override
	...
	{
		return "Toggle whether the currently selected battlefield is enabled or disabled.";
	}
	...
	{
		return Arrays.asList(getName(), "disable", "toggle");
	}
