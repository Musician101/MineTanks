...
public class Tanks
{
     ...
     * China Lights
     */
    public static final Tank WZ_132 = new Tank(CommonTanks.WZ_132, SpongeTankTypes.LIGHT, 1150, new Armor(50, 25, 20), 64, new SpongeCannon("100 mm 60-100T", 43, 7.57), new Engine("8V135", SpongeTankTypes.LIGHT), new Radio("A-220A", SpongeTankTypes.LIGHT), Tracks.WZ_132, Turrets.WZ_132, "Type: Light", "Very good agility and mobility.");
    /**
     * China Mediums
     */
    public static final Tank _121 = new Tank(CommonTanks._121, SpongeTankTypes.MEDIUM, 1950, new Armor(120, 80, 60), 56, new SpongeCannon("122 mm 60-122T", 40, 9.6), new Engine("12150L7", SpongeTankTypes.MEDIUM), new Radio("A-220B", SpongeTankTypes.MEDIUM), Tracks._121, Turrets._121, "Type: Medium", "Very high damage per shell and minute.");
    /**
     * China Heavies
     */
    public static final Tank _113 = new Tank(CommonTanks._113, SpongeTankTypes.HEAVY, 2300, new Armor(120, 90, 70), 50, new SpongeCannon("122 mm 60-122T", 34, 10.45), new Engine("V-2-54SC", SpongeTankTypes.HEAVY), new Radio("A-220B", SpongeTankTypes.HEAVY), Tracks._113, Turrets._113, "Type: Heavy", "Good mobility and high top speed.");
    /**
     * France Lights
     */
     ...
     * American Mediums
     */
    public static final Tank M48A1_PATTON = new Tank(CommonTanks.M48A1_Patton, SpongeTankTypes.MEDIUM, 2000, new Armor(152.4, 76.2, 38.1), 45, new SpongeCannon("105 mm Gun M68", 57, 8.44), new Engine("Continental AV-1790-7B", SpongeTankTypes.MEDIUM), new Radio("AN/VRC-7", SpongeTankTypes.MEDIUM), Tracks.T97E2, Turrets.M87, "Type: Medium", "Low top speed.", "Good damage.");
    public static final Tank M60 = new Tank(CommonTanks.M60, SpongeTankTypes.MEDIUM, 2000, new Armor(93.2, 73.7, 25.4), 48, new SpongeCannon("105 mm Gun M68", 57, 8.44), new Engine("Continental AVDS-1790-2", SpongeTankTypes.MEDIUM), new Radio("AN/VRC-12", SpongeTankTypes.MEDIUM), Tracks.M60, Turrets.M60, "Type: Medium", "Great mobility and rate of fire.", "Relatively thin armor.");
    /**
     * American Heavies
     */
    public static final Tank T110E5 = new Tank(CommonTanks.T110E5, SpongeTankTypes.HEAVY, 2200, new Armor(254, 76.2, 38.1), 37, new SpongeCannon("120 mm Gun M58", 42, 9.59), new Engine("Continental AOI-1490", SpongeTankTypes.HEAVY), new Radio("AN/VRC-3", SpongeTankTypes.HEAVY), Tracks.T110E27, Turrets.T53, "Type: Heavy", "Excellent damage per minute.", "Low side and rear armor.");
    public static final Tank T57 = new Tank(CommonTanks.T57, SpongeTankTypes.HEAVY, 2250, new Armor(203, 50.8, 38.1), 35, new SpongeAutoLoader("120 mm Gun T179", 36, 23.97, 2, 4), new Engine("Continental AV-1790-5C", SpongeTankTypes.HEAVY), new Radio("AN/VRC-3", SpongeTankTypes.HEAVY), Tracks.T97, Turrets.T169, "Type: Heavy", "Highest damage per minute of all heavy tanks.", "SpongeCannon has a clip for quick damage, but a long base reload.");
    /**
     * American TDs
     */
    public static final Tank T110E3 = new Tank(CommonTanks.T110E3, SpongeTankTypes.TD, 2050, new Armor(305, 76, 38), 30, new SpongeCannon("155 mm AT Gun T7E2", 27, 16.3), new Engine("Continental AOI-1490", SpongeTankTypes.TD), new Radio("AN/VRC-3", SpongeTankTypes.TD), Tracks.T110E3, Turrets.NO_TURRET_TD, "Type: TD", "Some of the toughest armor.", "Poor mobility.");
    public static final Tank T110E4 = new Tank(CommonTanks.T110E4, SpongeTankTypes.TD, 2000, new Armor(260, 76, 38), 35, new SpongeCannon("155 mm AT Gun T7E2", 27, 18.7), new Engine("Continental AOI-1490", SpongeTankTypes.TD), new Radio("AN/VRC-3", SpongeTankTypes.TD), Tracks.T110E4, Turrets.T110E4, "Type: TD", "Decent mobility.");
    /**
     * American Arty
     */
    ...
    public static final Tank T_62A = new Tank(CommonTanks.T_62A, SpongeTankTypes.MEDIUM, 1950, new Armor(100, 80, 45), 50, new SpongeCannon("100 mm U-8TS", 50, 6.33), new Engine("V-55", SpongeTankTypes.MEDIUM), new Radio("R-123", SpongeTankTypes.MEDIUM), Tracks.T_62A, Turrets.T_62A, "Type: Medium", "Very high damage per minute.", "Very strong turret armor.");
    /**
     * Russian Heavies
     */
    public static final Tank IS_4 = new Tank(CommonTanks.IS_4, SpongeTankTypes.HEAVY, 2500, new Armor(140, 160, 100), 43, new SpongeCannon("122 mm M62-T2", 30, 11.51), new Engine("V-12", SpongeTankTypes.HEAVY), new Radio("10RK-26", SpongeTankTypes.HEAVY), Tracks.IS_4M, Turrets.IS_4M, "Type: Heavy", "High health pool.", "Lacks mobility and damage per minute.");
    public static final Tank IS_7 = new Tank(CommonTanks.IS_7, SpongeTankTypes.HEAVY, 2150, new Armor(150, 150, 100), 60, new SpongeCannon("130 mm S-70", 30, 13.14), new Engine("M-50T", SpongeTankTypes.HEAVY), new Radio("10RK-26", SpongeTankTypes.HEAVY), Tracks.IS_7, Turrets.IS_7, "Type: Heavy", "Amazingly thick armor.");
    public static final Tank OBJECT_260 = new Tank(CommonTanks.OBJECT_260, SpongeTankTypes.HEAVY, 2100, new Armor(150, 150, 70), 60, new SpongeCannon("122 mm BL-13-1", 30, 11.03), new Engine("2x V-16", SpongeTankTypes.HEAVY), new Radio("10RK-26", SpongeTankTypes.HEAVY), Tracks.OBJECT_260_MOD_1945, Turrets.OBJECT_260_MOD_1945, "Type: Heavy", "Superior gun to the IS-4.", "Low health point pool for a heavy tank.");
    /**
     * Russian TDs
     */
    public static final Tank OBJECT_263 = new Tank(CommonTanks.OBJECT_263, SpongeTankTypes.TD, 1900, new Armor(250, 80, 50), 55, new SpongeCannon("130 mm S-70A", 42, 10.26), new Engine("M-50T", SpongeTankTypes.TD), new Radio("10RK-26", SpongeTankTypes.TD), Tracks.OBJECT_263, Turrets.NO_TURRET_TD, "Type: TD", "Great mobility.", "Low damage.");
    public static final Tank OBJECT_268 = new Tank(CommonTanks.OBJECT_268, SpongeTankTypes.TD, 1950, new Armor(187, 100, 50), 48, new SpongeCannon("152 mm M64", 35, 15.82), new Engine("V-16FN", SpongeTankTypes.TD), new Radio("R-113M", SpongeTankTypes.TD), Tracks.OBJECT_268, Turrets.NO_TURRET_TD, "Type: TD", "Good damage per minute.", "Good top speed.");
    /**
     * Russian Arty
     */
    public static final Tank OBJECT_261 = new Tank(CommonTanks.OBJECT_261, SpongeTankTypes.ARTY, 510, new Armor(75, 50, 30), 50, new SpongeCannon("180 mm B-1-P", 18, 33.56), new Engine("M-50T", SpongeTankTypes.ARTY), new Radio("10RK-26", SpongeTankTypes.ARTY), Tracks.OBJECT_261, Turrets.NO_TURRET_ARTY, "Type: SPG", "Fairly mobile.");
