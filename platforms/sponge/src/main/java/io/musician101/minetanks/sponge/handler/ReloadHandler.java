...
{
    private final SpongeMineTanks plugin;
    private final Player player;
    private final SpongeCannon cannon;
    private final int clipSize;

    public ReloadHandler(SpongeMineTanks plugin, Player player, SpongeCannon cannon, int clipSize)
    {
        this.plugin = plugin;
        this.player = player;
        this.cannon = cannon;
