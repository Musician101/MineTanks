...
public class RegionSpongeCommand extends AbstractSpongeCommand<SpongeMineTanks>
{
    public RegionSpongeCommand(SpongeMineTanks plugin)
    {
        super(plugin, CommonCommands.REGION_NAME, TextUtils.aquaText(CommonCommands.REGION_DESC), new SpongeCommandUsage(Arrays.asList(new SpongeCommandArgument(CommonCommands.MT_CMD), new SpongeCommandArgument(CommonCommands.REGION_NAME), new SpongeCommandArgument(CommonCommands.FIELD, Syntax.REPLACE, Syntax.REQUIRED), new SpongeCommandArgument(CommonCommands.RADIUS, Syntax.REPLACE, Syntax.REQUIRED)), 2), new SpongeCommandPermissions(CommonPermissions.EDIT_PERM, true, TextUtils.redText(CommonMessages.NO_PERMISSION), TextUtils.redText(CommonMessages.PLAYER_ONLY)));
    }
