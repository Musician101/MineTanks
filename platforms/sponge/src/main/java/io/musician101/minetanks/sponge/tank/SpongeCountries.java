...
public class SpongeCountries
{
    public static final SpongeCountry CHINA = new SpongeCountry("China",
            ItemStack.builder().itemType(ItemTypes.BANNER).add(Keys.DISPLAY_NAME, Text.of("China"))
                    .add(Keys.BANNER_BASE_COLOR, DyeColors.RED)
                    .add(Keys.BANNER_PATTERNS, Arrays.asList(PatternLayer.of(BannerPatternShapes.SQUARE_TOP_RIGHT, DyeColors.YELLOW),
    ...
    public static final SpongeCountry CZECH = new SpongeCountry("Czechoslovakia",
            ItemStack.builder().itemType(ItemTypes.BANNER).add(Keys.DISPLAY_NAME, Text.of("Czechoslovakia"))
                    ...
                    .add(Keys.BANNER_PATTERNS, Arrays.asList(PatternLayer.of(BannerPatternShapes.DIAGONAL_LEFT_MIRROR, DyeColors.RED),
    ...
    public static final SpongeCountry FRANCE = new SpongeCountry("France",
            ItemStack.builder().itemType(ItemTypes.BANNER).add(Keys.DISPLAY_NAME, Text.of("France"))
                    .add(Keys.BANNER_BASE_COLOR, DyeColors.WHITE)
                    .add(Keys.BANNER_PATTERNS, Arrays.asList(PatternLayer.of(BannerPatternShapes.STRIPE_TOP, DyeColors.BLUE),
                            PatternLayer.of(BannerPatternShapes.STRIPE_TOP, DyeColors.RED))).build());
    public static final SpongeCountry GERMANY = new SpongeCountry("Germany",
    ...
    public static final SpongeCountry JAPAN = new SpongeCountry("Japan",
            ItemStack.builder().itemType(ItemTypes.BANNER).add(Keys.DISPLAY_NAME, Text.of("Japan"))
                    .add(Keys.BANNER_BASE_COLOR, DyeColors.WHITE)
                    .add(Keys.BANNER_PATTERNS, Collections.singletonList(PatternLayer.of(BannerPatternShapes.CIRCLE_MIDDLE, DyeColors.RED))).build());
    public static final SpongeCountry UK = new SpongeCountry("U.K.",
            ItemStack.builder().itemType(ItemTypes.BANNER).add(Keys.DISPLAY_NAME, Text.of("U.K."))
                    .add(Keys.BANNER_BASE_COLOR, DyeColors.BLUE)
                    .add(Keys.BANNER_PATTERNS, Arrays.asList(PatternLayer.of(BannerPatternShapes.STRIPE_DOWNLEFT, DyeColors.WHITE),
    ...
    public static final SpongeCountry USA = new SpongeCountry("U.S.A.",
            ItemStack.builder().itemType(ItemTypes.BANNER).add(Keys.DISPLAY_NAME, Text.of("U.S.A."))
                    .add(Keys.BANNER_BASE_COLOR, DyeColors.RED)
                    .add(Keys.BANNER_PATTERNS, Arrays.asList(PatternLayer.of(BannerPatternShapes.STRIPE_SMALL, DyeColors.WHITE),
                            PatternLayer.of(BannerPatternShapes.SQUARE_TOP_RIGHT, DyeColors.BLUE))).build());
    public static final SpongeCountry USSR = new SpongeCountry("U.S.S.R.",
            ItemStack.builder().itemType(ItemTypes.BANNER).add(Keys.DISPLAY_NAME, Text.of("U.S.S.R."))
                    .add(Keys.BANNER_BASE_COLOR, DyeColors.RED)
                    .add(Keys.BANNER_PATTERNS, Arrays.asList(PatternLayer.of(BannerPatternShapes.CROSS, DyeColors.YELLOW),
    ...
    public static final List<SpongeCountry> ALL = Arrays.asList(CHINA, CZECH, FRANCE, GERMANY, JAPAN, UK, USA, USSR);

    public static SpongeCountry getByName(String name)
    {
        for (SpongeCountry country : ALL)
