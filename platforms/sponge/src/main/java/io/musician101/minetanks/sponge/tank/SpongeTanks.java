...
{
    /** China Lights */
    public static final SpongeTank WZ_132 = new SpongeTank(CommonTanks.WZ_132, SpongeCountries.CHINA, SpongeTankTypes.LIGHT, 1150, new Armor(50, 25, 20), 64, new SpongeModules(new SpongeCannon(CommonCannons._100_MM_60_100T, 43, 7.57), new SpongeEngine(CommonEngines._8V135, SpongeTankTypes.LIGHT), new SpongeRadio(CommonRadios.A_220A, SpongeTankTypes.LIGHT), SpongeTracks.WZ_132, SpongeTurrets.WZ_132));
    /** China Mediums */
    public static final SpongeTank _121 = new SpongeTank(CommonTanks._121, SpongeCountries.CHINA, SpongeTankTypes.MEDIUM, 1950, new Armor(120, 80, 60), 56, new SpongeModules(new SpongeCannon(CommonCannons._122_MM_60_122T, 40, 9.6), new SpongeEngine(CommonEngines._12150L7, SpongeTankTypes.MEDIUM), new SpongeRadio(CommonRadios.A_220B, SpongeTankTypes.MEDIUM), SpongeTracks._121, SpongeTurrets._121));
    /** China Heavies */
    public static final SpongeTank _113 = new SpongeTank(CommonTanks._113, SpongeCountries.CHINA, SpongeTankTypes.HEAVY, 2300, new Armor(120, 90, 70), 50, new SpongeModules(new SpongeCannon(CommonCannons._122_MM_60_122T, 34, 10.45), new SpongeEngine(CommonEngines.V_2_54SC, SpongeTankTypes.HEAVY), new SpongeRadio(CommonRadios.A_220B, SpongeTankTypes.HEAVY), SpongeTracks._113, SpongeTurrets._113));
    /** Czechoslovakian Mediums */
    public static final SpongeTank TVP_T_50_51 = new SpongeTank(CommonTanks.TVP_T_50_51, SpongeCountries.CZECH, SpongeTankTypes.MEDIUM, 1800, new Armor(65, 40, 30), 60, new SpongeModules(new SpongeAutoLoader(CommonCannons._100_MM_AK1, 48, 23.97, 1.5, 4), new SpongeEngine(CommonEngines.PRAGA_AXK, SpongeTankTypes.MEDIUM), new SpongeRadio(CommonRadios.RADIOSTANICE_RM_31T, SpongeTankTypes.MEDIUM), SpongeTracks.TVP_T_50_51, SpongeTurrets.TVP_T_50_51));
    /** France Lights */
    ...
    /** British Heavies */
    public static final SpongeTank FV215B = new SpongeTank(CommonTanks.FV215B, SpongeCountries.UK, SpongeTankTypes.HEAVY, 2500, new Armor(152.4, 101.6, 76.2), 34, new SpongeModules(new SpongeCannon(CommonCannons._120_MM_GUN_L1A1, 35, 8.34), new SpongeEngine(CommonEngines.ROLLS_ROYCE_GRIFFON, SpongeTankTypes.HEAVY), new SpongeRadio(CommonRadios.SR_C45, SpongeTankTypes.HEAVY), SpongeTracks.FV215, SpongeTurrets.FV215));
    /** British TDs */
    public static final SpongeTank FV215B_183 = new SpongeTank(CommonTanks.FV215B_183, SpongeCountries.UK, SpongeTankTypes.TD, 2000, new Armor(152.4, 50.8, 76.2), 34, new SpongeModules(new SpongeCannon(CommonCannons._183_MM_L4, 12, 28.77), new SpongeEngine(CommonEngines.ROLLS_ROYCE_METEOR_MK_12, SpongeTankTypes.TD), new SpongeRadio(CommonRadios.SR_C45, SpongeTankTypes.TD), SpongeTracks.FV215B, SpongeTurrets.FV215B));
    public static final SpongeTank FV4005_STAGE_II = new SpongeTank(CommonTanks.FV4005_STAGE_II, SpongeCountries.UK, SpongeTankTypes.TD, 1850, new Armor(76.2, 50.8, 38.1), 35, new SpongeModules(new SpongeCannon(CommonCannons._183_MM_L4, 12, 28.77), new SpongeEngine(CommonEngines.ROLLS_ROYCE_METEOR_MK_IVB, SpongeTankTypes.TD), new SpongeRadio(CommonRadios.SR_C45, SpongeTankTypes.TD), SpongeTracks.FV4005_STAGE_II, SpongeTurrets.FV4005_STAGE_II));
    /** British Arty */
    public static final SpongeTank CONQUEROR_GC = new SpongeTank(CommonTanks.CONQUEROR_GC, SpongeCountries.UK, SpongeTankTypes.ARTY, 530, new Armor(152.4, 50.8, 76.2), 34, new SpongeModules(new SpongeCannon(CommonCannons.BL_9_2_IN_HOWITZER, 24, 55.71), new SpongeEngine(CommonEngines.ROLLS_ROYCE_METEOR_M120, SpongeTankTypes.ARTY), new SpongeRadio(CommonRadios.SR_C45, SpongeTankTypes.ARTY), SpongeTracks.CONQUEROR_GC, SpongeTurrets.NO_TURRET_ARTY));
    /** American Lights */
    ...
    /** American Mediums */
    public static final SpongeTank M48A1_PATTON = new SpongeTank(CommonTanks.M48A1_PATTON, SpongeCountries.USA, SpongeTankTypes.MEDIUM, 2000, new Armor(152.4, 76.2, 38.1), 45, new SpongeModules(new SpongeCannon(CommonCannons._105_MM_GUN_M68, 57, 8.44), new SpongeEngine(CommonEngines.CONTINENTAL_AV_1790_7B, SpongeTankTypes.MEDIUM), new SpongeRadio(CommonRadios.AN_VRC_7, SpongeTankTypes.MEDIUM), SpongeTracks.T97E2, SpongeTurrets.M87));
    public static final SpongeTank M60 = new SpongeTank(CommonTanks.M60, SpongeCountries.USA, SpongeTankTypes.MEDIUM, 2000, new Armor(93.2, 73.7, 25.4), 48, new SpongeModules(new SpongeCannon(CommonCannons._105_MM_GUN_M68, 57, 8.44), new SpongeEngine(CommonEngines.CONTINENTAL_AVDS_1790_2, SpongeTankTypes.MEDIUM), new SpongeRadio(CommonRadios.AN_VRC_12, SpongeTankTypes.MEDIUM), SpongeTracks.M60, SpongeTurrets.M60));
    /** American Heavies */
    public static final SpongeTank T110E5 = new SpongeTank(CommonTanks.T110E5, SpongeCountries.USA, SpongeTankTypes.HEAVY, 2200, new Armor(254, 76.2, 38.1), 37, new SpongeModules(new SpongeCannon(CommonCannons._120_MM_GUN_M58, 42, 9.59), new SpongeEngine(CommonEngines.CONTINENTAL_AOI_1490, SpongeTankTypes.HEAVY), new SpongeRadio(CommonRadios.AN_VRC_3, SpongeTankTypes.HEAVY), SpongeTracks.T110E27, SpongeTurrets.T53));
    public static final SpongeTank T57 = new SpongeTank(CommonTanks.T57, SpongeCountries.USA, SpongeTankTypes.HEAVY, 2250, new Armor(203, 50.8, 38.1), 35, new SpongeModules(new SpongeAutoLoader(CommonCannons._120_MM_GUN_T179, 36, 23.97, 2, 4), new SpongeEngine(CommonEngines.CONTINENTAL_AV_1790_5C, SpongeTankTypes.HEAVY), new SpongeRadio(CommonRadios.AN_VRC_3, SpongeTankTypes.HEAVY), SpongeTracks.T97, SpongeTurrets.T169));
    /** American TDs */
    public static final SpongeTank T110E3 = new SpongeTank(CommonTanks.T110E3, SpongeCountries.USA, SpongeTankTypes.TD, 2050, new Armor(305, 76, 38), 30, new SpongeModules(new SpongeCannon(CommonCannons._155_MM_AT_GUN_T7E2, 27, 16.3), new SpongeEngine(CommonEngines.CONTINENTAL_AOI_1490, SpongeTankTypes.TD), new SpongeRadio(CommonRadios.AN_VRC_3, SpongeTankTypes.TD), SpongeTracks.T110E3, SpongeTurrets.NO_TURRET_TD));
    public static final SpongeTank T110E4 = new SpongeTank(CommonTanks.T110E4, SpongeCountries.USA, SpongeTankTypes.TD, 2000, new Armor(260, 76, 38), 35, new SpongeModules(new SpongeCannon(CommonCannons._155_MM_AT_GUN_T7E2, 27, 18.7), new SpongeEngine(CommonEngines.CONTINENTAL_AOI_1490, SpongeTankTypes.TD), new SpongeRadio(CommonRadios.AN_VRC_3, SpongeTankTypes.TD), SpongeTracks.T110E4, SpongeTurrets.T110E4));
    /** American Arty */
    public static final SpongeTank T92 = new SpongeTank(CommonTanks.T92, SpongeCountries.USA, SpongeTankTypes.ARTY, 500, new Armor(25.4, 25.4, 21.7), 32, new SpongeModules(new SpongeCannon(CommonCannons._240_MM_HOWITZER, 16, 50.82), new SpongeEngine(CommonEngines.FORD_GAF_T92, SpongeTankTypes.ARTY), new SpongeRadio(CommonRadios.SCR_528A, SpongeTankTypes.ARTY), SpongeTracks.T92_T80E1, SpongeTurrets.NO_TURRET_ARTY));
    /** Russian Lights */
    public static final SpongeTank T_54_LTWT = new SpongeTank(CommonTanks.T_54_LTWT, SpongeCountries.USSR, SpongeTankTypes.LIGHT, 1250, new Armor(80, 60, 45), 69, new SpongeModules(new SpongeCannon(CommonCannons._100_MM_D10T, 34, 7.19), new SpongeEngine(CommonEngines.V_14, SpongeTankTypes.LIGHT), new SpongeRadio(CommonRadios._10RT_26, SpongeTankTypes.LIGHT), SpongeTracks.T_54_ENHANCED_LTWT_VERSION, SpongeTurrets.T_54_LTWT_VERSION));
    /** Russian Mediums */
    ...
    public static final SpongeTank OBJECT_430 = new SpongeTank(CommonTanks.OBJECT_430, SpongeCountries.USSR, SpongeTankTypes.MEDIUM, 1900, new Armor(120, 80, 40), 55, new SpongeModules(new SpongeCannon(CommonCannons._100_MM_8TS, 50, 6.14), new SpongeEngine(CommonEngines._5TD, SpongeTankTypes.MEDIUM), new SpongeRadio(CommonRadios.R_113M, SpongeTankTypes.MEDIUM), SpongeTracks.OBJECT_430, SpongeTurrets.OBJECT_430));
    public static final SpongeTank OBJECT_907 = new SpongeTank(CommonTanks.OBJECT_907, SpongeCountries.USSR, SpongeTankTypes.MEDIUM, 2000, new Armor(100, 85, 45), 55, new SpongeModules(new SpongeCannon(CommonCannons._100_MM_D_54TS, 45, 6.23), new SpongeEngine(CommonEngines.V_12_5U, SpongeTankTypes.MEDIUM), new SpongeRadio(CommonRadios.R_123, SpongeTankTypes.MEDIUM), SpongeTracks.OBJECT_907, SpongeTurrets.OBJECT_907));
    public static final SpongeTank T_62A = new SpongeTank(CommonTanks.T_62A, SpongeCountries.USSR, SpongeTankTypes.MEDIUM, 1950, new Armor(100, 80, 45), 50, new SpongeModules(new SpongeCannon(CommonCannons._100_MM_8TS, 50, 6.33), new SpongeEngine(CommonEngines.V_55, SpongeTankTypes.MEDIUM), new SpongeRadio(CommonRadios.R_123, SpongeTankTypes.MEDIUM), SpongeTracks.T_62A, SpongeTurrets.T_62A));
    /** Russian Heavies */
    public static final SpongeTank IS_4 = new SpongeTank(CommonTanks.IS_4, SpongeCountries.USSR, SpongeTankTypes.HEAVY, 2500, new Armor(140, 160, 100), 43, new SpongeModules(new SpongeCannon(CommonCannons._122_MM_M62_T2, 30, 11.51), new SpongeEngine(CommonEngines.V_12, SpongeTankTypes.HEAVY), new SpongeRadio(CommonRadios._10RK_26, SpongeTankTypes.HEAVY), SpongeTracks.IS_4M, SpongeTurrets.IS_4M));
    public static final SpongeTank IS_7 = new SpongeTank(CommonTanks.IS_7, SpongeCountries.USSR, SpongeTankTypes.HEAVY, 2150, new Armor(150, 150, 100), 60, new SpongeModules(new SpongeCannon(CommonCannons._130_MM_S_70, 30, 13.14), new SpongeEngine(CommonEngines.M_50T, SpongeTankTypes.HEAVY), new SpongeRadio(CommonRadios._10RK_26, SpongeTankTypes.HEAVY), SpongeTracks.IS_7, SpongeTurrets.IS_7));
    public static final SpongeTank OBJECT_260 = new SpongeTank(CommonTanks.OBJECT_260, SpongeCountries.USSR, SpongeTankTypes.HEAVY, 2100, new Armor(150, 150, 70), 60, new SpongeModules(new SpongeCannon(CommonCannons._122_MM_BL_13_1, 30, 11.03), new SpongeEngine(CommonEngines._2X_V_16, SpongeTankTypes.HEAVY), new SpongeRadio(CommonRadios._10RK_26, SpongeTankTypes.HEAVY), SpongeTracks.OBJECT_260_MOD_1945, SpongeTurrets.OBJECT_260_MOD_1945));
    /** Russian TDs */
    public static final SpongeTank OBJECT_263 = new SpongeTank(CommonTanks.OBJECT_263, SpongeCountries.USSR, SpongeTankTypes.TD, 1900, new Armor(250, 80, 50), 55, new SpongeModules(new SpongeCannon(CommonCannons._130_MM_S_70A, 42, 10.26), new SpongeEngine(CommonEngines.M_50T, SpongeTankTypes.TD), new SpongeRadio(CommonRadios._10RK_26, SpongeTankTypes.TD), SpongeTracks.OBJECT_263, SpongeTurrets.NO_TURRET_TD));
    public static final SpongeTank OBJECT_268 = new SpongeTank(CommonTanks.OBJECT_268, SpongeCountries.USSR, SpongeTankTypes.TD, 1950, new Armor(187, 100, 50), 48, new SpongeModules(new SpongeCannon(CommonCannons._152_MM_M64, 35, 15.82), new SpongeEngine(CommonEngines.V_16FN, SpongeTankTypes.TD), new SpongeRadio(CommonRadios.R_113M, SpongeTankTypes.TD), SpongeTracks.OBJECT_268, SpongeTurrets.NO_TURRET_TD));
    /** Russian Arty */
