...
public class LeaveSpigotCommand extends AbstractSpigotCommand<SpigotMineTanks>
{
    ...
    {
        super(plugin, CommonCommands.LEAVE_NAME, CommonCommands.LEAVE_DESC, new SpigotCommandUsage(Arrays.asList(new SpigotCommandArgument(CommonCommands.MT_CMD), new SpigotCommandArgument(CommonCommands.LEAVE_NAME))), new SpigotCommandPermissions(CommonPermissions.PARTICIPATE_PERM, true, ChatColor.RED + CommonMessages.NO_PERMISSION, ChatColor.RED + CommonMessages.PLAYER_ONLY));
    }
