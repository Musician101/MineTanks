...
public class SpigotTracks extends AbstractInfoStorage<SpigotTrackz>
{
    ...
    {
        super(
                new SpigotTrackz(CommonTracks._121, SpigotTankTypes.getTankType(CommonTankTypes.MEDIUM)),
                new SpigotTrackz(CommonTracks._113, SpigotTankTypes.getTankType(CommonTankTypes.HEAVY)),
