...
public class SpigotTurrets extends AbstractInfoStorage<SpigotTurret>
{
    private SpigotTurrets()
    {
        super(
                ...
                new SpigotTurret(CommonTurrets._121, SpigotTankTypes.getTankType(CommonTankTypes.MEDIUM), new Armor(240, 130, 60)),
                new SpigotTurret(CommonTurrets._113, SpigotTankTypes.getTankType(CommonTankTypes.HEAVY), new Armor(240, 160, 80)),
