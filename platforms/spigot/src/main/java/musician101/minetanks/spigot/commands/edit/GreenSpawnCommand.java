...
public class GreenSpawnCommand extends AbstractSpigotCommand
{
    ...
    {
        super(CommonCommands.GREEN_SPAWN_NAME, CommonCommands.GREEN_SPAWN_DESC, Arrays.asList(new CommandArgument("/" + CommonCommands.MT), new CommandArgument(CommonCommands.GREEN_SPAWN_NAME), new CommandArgument(CommonCommands.FIELD, Syntax.REQUIRED, Syntax.REPLACE)), 1, CommonPermissions.EDIT_PERM, true, ChatColor.RED + CommonMessages.NO_PERMISSION, ChatColor.RED + CommonMessages.PLAYER_ONLY);
        this.plugin = plugin;
    }
