...
public class RedSpawnCommand extends AbstractSpigotCommand
{
    ...
    {
        super("redspawn", "Set the red team's spawn point of the currently selected battlefield.", Arrays.asList("/mt", "redspawn", "<" + ChatColor.ITALIC + "field" + ChatColor.RESET + ">"), 1, "minetanks.edit", true, ChatColor.RED + "No Permission", ChatColor.RED + "Player Only");
        this.plugin = plugin;
    }
